...
tbl_job_categories.category_title from tbl_job_sub_categories left join tbl_job_categories ON (tbl_job_categories.id = tbl_job_sub_categories.category_id)";*/
		...
		join tbl_job_categories on(tbl_job_sub_categories.category_id=tbl_job_categories.id)";
		...
		{			
			...
			$json .= ",'<a href=\"".APPLICATION_URL."subcategory/edit/id/".$row['id']."\"><img title=\"Edit\" alt=\"Edit\" src=\"".APPLICATION_URL."/images/edit.png\" border=\"0\" /></a>'";			
			$json .= ",'<a href=\"".APPLICATION_URL."subcategory/del/id/".$row['id']."\"><img title=\"Delete\" alt=\"Delete\" src=\"".APPLICATION_URL."/images/deleteicon.png\" border=\"0\" /></a>'";			
			$json .= "]}";
			$rc = true;
			$i++;
		}
