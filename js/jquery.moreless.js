(function ($) {
    ...
    $.fn.moreless = function (options) {
        ...
        return this.each(function () {
            ...
            $('.' + opts.MycontentContainer).each(function () {
            ...
            $("." + opts.anchorClass).toggle(function () {
                //first click
                $(this).siblings('.' + opts.MycontentContainer).css('height', 'auto').css('overflow', 'visible');
                $(this).text(opts.lessText);
            }, function () {
                //second click
                $(this).siblings('.' + opts.MycontentContainer).css('height', opts.startHeight).css('overflow', 'hidden');
