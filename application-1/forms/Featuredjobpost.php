<?php
class Form_Featuredjobpost extends Zend_Form
{
...
/*---------------------------------------- Employment Type ----------------------------------------------------*/
		...
		$Employment_Type->addMultiOptions($EmploymentArr)		
			...
			->addDecorator('Errors', array('class'=>'errormsg'))
			->setAttrib("style","width:155px;");
		$Employment_Type->class="inputbox";
...
/*---------------------------------------- Experience ----------------------------------------------------*/		
		...
		$Travel_Required->setRequired(true)
				...
				->setAttrib("style","width:155px;")
				->addDecorator('Errors', array('class'=>'errormsg'));
		$Travel_Required->class="inputbox";		
...
/*---------------------------------------- Relocation ----------------------------------------------------*/		
		...
		$Company_Logo = new Zend_Form_Element_File('Company_Logo');	
		$Company_Logo->setAttrib("style", "width:400px;");
		$Company_Logo->class="inputbox";
		$this->addElements(array($Company_Logo));
		
		$Header_Banner = new Zend_Form_Element_File('Header_Banner');	
		//$Header_Banner->setAttrib("style", "width:400px;");
		//$Header_Banner->setValue(@$Header_Banner_Value);
		//$Header_Banner->class="file-wrapper";
		$this->addElements(array($Header_Banner));
		
		$Content_Banner = new Zend_Form_Element_File('Content_Banner');	
		//$Content_Banner->setAttrib("style", "width:400px;");
		//$Content_Banner->setValue(@$Content_Banner_Value);
		//$Content_Banner->class="file-wrapper";
		$this->addElements(array($Content_Banner));
