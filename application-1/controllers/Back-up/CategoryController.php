...
class CategoryController extends Zend_Controller_Action
{
	...
	{	
		...
		{			
			...
			$json .= ",'<a href=\"".APPLICATION_URL."category/edit/id/".$row['id']."\"><img title=\"Edit\" alt=\"Edit\" src=\"".APPLICATION_URL."/images/edit.png\" border=\"0\" /></a>'";			
			$json .= ",'<a href=\"".APPLICATION_URL."category/del/id/".$row['id']."\"><img title=\"Delete\" alt=\"Delete\" src=\"".APPLICATION_URL."/images/deleteicon.png\" border=\"0\" /></a>'";			
			$json .= "]}";
			$rc = true;
			$i++;
		}
...
//----------------------------------- Uploading Image Files -----------------------------------------------------------
	...
	{	
		...
		if($arr['id']) {
		$this->view->id = $arr['id'];
		$form = new Form_Category($arr['id']);
		$this->view->myform=$form;	
		
		$qry="SELECT * FROM tbl_job_categories where id='".$arr['id']."'";	
