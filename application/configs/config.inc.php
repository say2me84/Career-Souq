...
define('APPLICATION_URL', "http://localhost/sybite/career_souq/");

//define('APPLICATION_URL', "http://appsshoppy.com/career_souq/");
	
define('BASE_PATH', APPLICATION_URL);

define('APPLICATION_URL_ADMIN', "http://localhost/sybite/career_souq/admin/");
...
// ================== PDF Creating ===================//
	define('PDF_URL', APPLICATION_URL.'dompdf/');
// ================== PDF Creating ===================//
